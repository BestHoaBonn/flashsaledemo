...
Tính năng: US2 - Xử lý tồn kho và thanh toán
  ...
  Kịch bản: 2.1 - Thanh toán hợp lệ (Happy Path)
    ...
    Khi khách hàng chọn "1" sản phẩm và thanh toán
  ...
  Kịch bản: 2.2 - Thanh toán khi hết kho khuyến mãi (Unhappy Path)
    ...
    Thì hệ thống báo lỗi "Sản phẩm đã hết suất Flash Sale" và cập nhật lại màn hình về giá gốc

  Kịch bản: 2.3 - Thanh toán với số lượng không hợp lệ (Unhappy Path)
    Cho kho Flash Sale còn "10" sản phẩm
    Khi khách hàng chọn "0" sản phẩm và thanh toán
    Thì hệ thống báo lỗi "Số lượng mua phải lớn hơn 0" và cập nhật lại màn hình về giá gốc
