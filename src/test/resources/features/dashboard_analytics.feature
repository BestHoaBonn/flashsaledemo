...
Tính năng: US4 - Báo cáo hiệu quả thời gian thực
  ...
  Kịch bản: 4.1 - Xem báo cáo khi có đơn hàng (Happy Path)
  ...
  Kịch bản: 4.2 - Xem báo cáo khi bị lỗi chia cho 0 (Unhappy Path)
  ...
  Kịch bản: 4.3 - Xem báo cáo khi chưa có giao dịch nào (Unhappy Path)
