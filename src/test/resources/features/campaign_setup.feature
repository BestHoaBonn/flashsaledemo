...
Tính năng: US3 - Thiết lập chiến dịch
  ...
  Kịch bản: 3.1 - Tạo chiến dịch hợp lệ (Happy Path)
  ...
  Kịch bản: 3.2 - Mức giảm giá vượt quá biên lợi nhuận (Unhappy Path)
  ...
  Kịch bản: 3.3 - Thiết lập thời gian sai (Unhappy Path)
